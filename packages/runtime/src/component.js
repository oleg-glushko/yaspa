...
export function defineComponent({ render, state, onMounted = emptyFn,
    onUnmounted = emptyFn, ...methods }) {
    class Component {
        #isMounted = false;
        #vdom = null;
        #hostEl = null;
        ...
        get offset() {
            if (this.#vdom.type === DOM_TYPES.FRAGMENT)
                return Array.from(this.#hostEl.children)
                    .indexOf(this.firstElement);
